...
💡 Important: Remember to create a new repository, update the remote (`git remote set-url <your new url>`), and upload the code to your new repository using `add`, `commit` and `push`.
